...
public class VerifyCode
{
    ...
    private Color _fontColor = Color.Black;          //验证码色51aspx
    private int _rateNumber = 100;              //验证码中的数字出现机率  ，越大出现的数字机率越大
    private string _randomChars;              //随机生成的验证码
    private int _randomAngle = 10;              //随机码的旋转角度
    private string _fontFamily = "Verdana";        //字体
    private int _chaosNumber = 2;                //噪点数量  ,0  时不用
