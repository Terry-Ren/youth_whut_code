<%@ Page Title="" Language="C#" MasterPageFile="~/master/admin.master" AutoEventWireup="true"
    CodeBehind="IndexList.aspx.cs" Inherits="AUTO.youth_admin.IndexContent.IndexList" %>
    ...
    <div id="box">
        <div id="box_top">
            <asp:LinkButton ID="lbtnAdd" runat="server" CssClass="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'"
                OnClick="lbtnAdd_Click">添加首页版块</asp:LinkButton>
            首页版块名称：<asp:TextBox ID="txtWord" runat="server"></asp:TextBox>
        ...
        <div id="box_middle">
            <asp:GridView ID="gvwData" runat="server" AutoGenerateColumns="false" CssClass="table"
                HorizontalAlign="Center" DataKeyNames="menu_id">
                <Columns>
