<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu_StationMaster.aspx.cs"
    Inherits="AUTO.youth_admin.Menu_StationMaster" %>
...
<body class="easyui-layout">
    ...
    <div data-options="region:'west',split:true" title="后台管理" style="width: 200px; padding: 1px;
        ...
        <div class="easyui-accordion" data-options="fit:true,border:false">
            ...
            <div title="用户管理" data-options="selected:true" style="padding: 2px; overflow: auto;"
                runat="server" id="Div1">
                <ul>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('用户管理','Users/youth_UserList.aspx')">
                        用户管理</a></span></li>
                </ul>
            </div>
            <div title="文件管理" data-options="selected:true" style="padding: 2px; overflow: auto;"
                ...
                <ul>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('文件管理','FileUpload/fileUpload.aspx')">
                        文件管理</a></span></li>
                </ul>
            </div>
            <div title="精品专题" data-options="selected:true" style="padding: 2px; overflow: auto;"
                runat="server" id="Div3">
                <ul>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('精品专题列表','SpeSubject/specialItemList.aspx')">
                        精品专题列表</a></span></li>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('专题栏目列表','SpeSubject/spe_subjectItemList.aspx')">
                        专题栏目列表</a></span></li>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('栏目内容列表','SpeSubject/spe_sub_conItemList.aspx')">
                        栏目内容列表</a></span></li>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('更换首页banner','SpeSubject/ChangeBanner.aspx')">
                        更换banner</a></span></li>
                </ul>
            </div>
            <div title="书记专栏" data-options="selected:true" style="padding: 2px; overflow: auto;"
                runat="server" id="Div4">
                <ul>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('书记专栏','MeetingRoom/questionList.aspx')">
                        书记专栏</a></span></li>
                </ul>
            </div>
            <div title="视频专区" data-options="selected:true" style="padding: 2px; overflow: auto;"
                runat="server" id="Div5">
                <ul>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('视频专区','Video/VideoList.aspx')">
                        视频专区</a></span></li>
                </ul>
            </div>
            <div title="图说理工" data-options="selected:true" style="padding: 2px; overflow: auto;"
                runat="server" id="Div7">
                <ul>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('图说理工','TuShuoLG/TuShuoLGList.aspx')">
                        图说理工</a></span></li>
                </ul>
            </div>
            <div title="版块设置" data-options="selected:true" style="padding: 2px; overflow: auto;"
                runat="server" id="Div6">
                <ul>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('新闻版块设置','IndexContent/NewsColList.aspx')">
                        新闻版块设置</a></span></li>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('书记会客版块','IndexContent/ReceptionType.aspx')">
                        书记会客版块</a></span></li>
            ...
            <div title="新闻排行" data-options="selected:true" style="padding: 2px; overflow: auto;"
                ...
                <ul>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('新闻排行','NewsRange/NewsRange.aspx')">
                        新闻排行</a></span></li>
                    <li><span><a href="#" class="easyui-linkbutton" onclick="addTab('稿件清零','NewsRange/ClearRange.aspx')">
                        稿件清零</a></span></li>
                </ul>
            </div>
        </div>
