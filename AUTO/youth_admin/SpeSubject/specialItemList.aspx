<%@ Page Title="" Language="C#" MasterPageFile="~/master/admin.master" AutoEventWireup="true"
    CodeBehind="specialItemList.aspx.cs" Inherits="AUTO.youth_admin.SpeSubject.specialItemList" %>
    ...
    <div id="box">
        <div id="box_top">
            <asp:LinkButton ID="addAdmin" runat="server" CssClass="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'"
                OnClick="addAdmin_Click">添加专题</asp:LinkButton>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnReset" runat="server" CssClass="easyui-linkbutton" data-options="plain:true,iconCls:'icon-cut'"
                                CommandArgument='<%#Eval("special_id") %>' OnClick="lbtnReset_Click">编辑</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
