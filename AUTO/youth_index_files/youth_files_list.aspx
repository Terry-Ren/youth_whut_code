<%@ Page Title="" Language="C#" MasterPageFile="~/master/index.Master" AutoEventWireup="true"
    CodeBehind="youth_files_list.aspx.cs" Inherits="AUTO.youth_index_files.youth_files_list" %>
    ...
    <div class="maincontent fix">
        <div class="content">
            ...
            <div class="detail_content">
                ...
                <div class="news2 fix">
                    <ul>
                        <asp:Repeater ID="rpt_files_list" runat="server">
                            <ItemTemplate>
                                <li><a href='youth_file.aspx?file_id=<%#Eval("file_id") %>' title='<%# Eval("file_title")%>'>
                                    <%# CutString(Eval("file_title").ToString())%></a> <span>
        ...
        <div class="side">
            <div class="annou hei1 fix">
                <h2 class="block_title" style="border-top: none;">
                    <a href='youth_files_list.aspx?file_father_id=<%=file_father_id %>' class="more">more</a><label
